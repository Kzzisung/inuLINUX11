...
function view_cpu_usage() {
    ...
    # [TODO] 여기에 process-monitor 기능 코드를 넣거나 실행 명령을 적으세요.
    # 예: ./monitor.sh
    echo ">> (기능이 아직 연결되지 않았습니다)"
}
...
function view_network_status() {
    ...
    # [TODO] 여기에 netstat 기능 코드를 넣거나 실행 명령을 적으세요.
    # 예: ./my_netstat.sh
    echo ">> (기능이 아직 연결되지 않았습니다)"
}
...
function run_compiler() {
    ...
    # [TODO] 여기에 compiler 기능 코드를 넣거나 실행 명령을 적으세요.
    # 예: ./compiler.sh
    echo ">> (기능이 아직 연결되지 않았습니다)"
}
